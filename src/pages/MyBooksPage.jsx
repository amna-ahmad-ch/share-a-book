      ...
      {profile && (
        <div className="rounded-xl bg-white p-4 border border-primary/5 space-y-1">
          <div className="flex items-start justify-between gap-2">
            ...
            <Link
              to="/profile/edit"
              className="shrink-0 text-xs text-accent font-semibold px-2 py-1 rounded-lg border border-accent/30"
            >
              Edit
            </Link>
          </div>
            ...
            >
              ...
              <div className="shrink-0 self-center flex flex-col gap-1.5">
                <Link
                  ...
                  className="text-xs text-primary font-semibold px-2 py-1.5 rounded border border-primary/20 text-center"
                >
                  Edit
                </Link>
                <button
                  ...
                  className="text-xs bg-red-500 text-white px-2 py-1.5 rounded font-bold"
                >
                  Delete
                </button>
              </div>
